...
class King:
    ...
    def axe(self,V):
        ...
        for pos in options:
            self.attack_target(options[pos],self.levithianAxe)

    def dhaiKiloKaHaath(self,V):
        if(self.alive == False):
            return
        a = self.position[0]
        b = self.position[1]
    ...
    def rage_effect(self):
        ...
        self.levithianAxe = self.levithianAxe*2
