...
class Village:
    def __init__(self,config):
        ...
        self.spawn_points = config['spawn_points'] # oords spawn points of the village
        self.town_hall = config['town_hall']       # coords of top left corner of town hall of the village
        self.huts = config['huts']                 # coords of top left corner of huts of the village
        self.walls_top = config['walls_top']       # coords of walls of the village
        ...
        self.cannons = config['cannons']           # coords of top left corner of cannons of the village
        self.hut_objs = {}
        self.cannon_objs = {}
        self.wall_objs = {}
    ...
    def generate_map(self):
        ...
        for cannon in self.cannons:                                     # cannon is 2x2
            ...
            map[cannon[0]][cannon[1]] = pt.CANNON + ":" + str(cannon[0]) + ":" + str(cannon[1])
            map[cannon[0]+1][cannon[1]] = pt.CANNON + ":" + str(cannon[0]) + ":" + str(cannon[1])
            map[cannon[0]][cannon[1]+1] = pt.CANNON + ":" + str(cannon[0]) + ":" + str(cannon[1])
            map[cannon[0]+1][cannon[1]+1] = pt.CANNON + ":" + str(cannon[0]) + ":" + str(cannon[1])
    ...
    def check_if_game_over(self,King):
        all_buildings = collections.ChainMap(self.hut_objs,self.cannon_objs)
        if len(all_buildings) == 0 and self.town_hall_obj == None:
            return 1
        elif King.alive == False and len(barbarians) == 0 and len(dragons) == 0:
            return 2
        else:
            return 0
